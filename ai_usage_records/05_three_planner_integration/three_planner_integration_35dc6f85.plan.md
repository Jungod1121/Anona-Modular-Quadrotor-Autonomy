...
todos:
  - id: phase1-gcopter
    content: Refresh gcopter_vendor from yuwei-wu/GCOPTER ros2; keep plant /planner pubs; update VENDOR_NOTES
    status: completed
  - id: phase2-mighty
    content: Vendor MIGHTY core + Decomp/dynus_interfaces; mighty_cmd_bridge + mighty_avoidance.launch + dashboard Path E
    status: completed
  - id: phase3-fast
    content: Vendor Fast-Planner ROS2 port; PositionCommand bridge; fast_planner_avoidance.launch + dashboard Path F
    status: completed
  - id: wire-docs-smoke
    content: Register planner_sim/maps_catalog/i18n/PLANNERS.md; smoke forest+maze for C/E/F
    status: completed
isProject: false
---
