...
\newcommand{\figmaxh}{0.28\textheight}
\raggedbottom
...
\newcommand{\MapThumb}[1]{%
  \includegraphics[width=0.32\linewidth,height=0.15\textheight,keepaspectratio]{#1}%
}
%% 栏内并排且不浮动：正文后紧跟配图
\newcommand{\ScenarioPair}[4]{%
  ...
  \noindent\begin{minipage}{\linewidth}
    ...
    \begin{minipage}[t]{0.48\linewidth}
      \centering
      \includegraphics[width=\linewidth,height=0.20\textheight,keepaspectratio]{#1}%
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\linewidth}
      \centering
      \includegraphics[width=\linewidth,height=0.20\textheight,keepaspectratio]{#2}%
    \end{minipage}
    \vspace{0.15em}%
    \captionof{figure}{#3}%
    \label{#4}%
...
\newcommand{\QuadFigures}[6]{%
  ...
  \noindent\begin{minipage}{\linewidth}
    ...
    \begin{tabular}{@{}cccc@{}}
      \includegraphics[width=0.235\linewidth,height=0.12\textheight,keepaspectratio]{#1}&
      \includegraphics[width=0.235\linewidth,height=0.12\textheight,keepaspectratio]{#2}&
      \includegraphics[width=0.235\linewidth,height=0.12\textheight,keepaspectratio]{#3}&
      \includegraphics[width=0.235\linewidth,height=0.12\textheight,keepaspectratio]{#4}
    \end{tabular}
    \vspace{0.15em}%
    \captionof{figure}{#5}%
    \label{#6}%
...
%% 摘要区：左右缩进同宽；每段首行缩进 2em（不用 quote，避免 list 吃掉缩进）
...
%% ========== 目录后：双栏正文（附件报告见 report/appendix/，不编入 PDF）==========
\twocolumn
\pagestyle{fancy}
\setlength{\parskip}{5.5pt}
