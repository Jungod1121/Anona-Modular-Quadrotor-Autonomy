...
todos:
  - id: revert-glass
    content: Remove LiquidGlass WebGL/page-scene; restore CSS frost + fixed night CSS bg
    status: completed
  - id: xy-track-ui
    content: Add shared XY track panel markup + CSS on all pages
    status: completed
  - id: xy-track-logic
    content: Ring-buffer odom/swarm XY in app.js, draw canvas, clear on start/restart
    status: completed
isProject: false
---
