...
> 自动生成时间：2026-07-24 21:39:45 CST
> 通过：**6/6** 场景
...
| 4 | 静态避障 | `avoidance.launch.py` | ✅ PASS | mean_err=28.1727 m; final=19.1843 m; min_obs=0.3161 m; planner_ok=True; hold=False; wp=8/8 |
...
- 原始指标：
  - `samples`: 5602
  - `mean_pos_err`: 28.1727 m
  - `max_pos_err`: 53.8350 m
  - `final_pos_err`: 19.1843 m
  ...
  - `min_obstacle_distance`: 0.3161 m
  - `avoidance_safety_distance`: 0.3000 m
  - `avoidance_pass`: True
  - `avoidance_pass_0.35m`: False
  - `flown_path_length`: 668.8094 m
  - `detour_ratio`: 73.2308
  - `mean_jerk`: 10.8349 m/s^3
  - `planned_tracking_error_mean`: 30.0222 m
- launch 日志末尾（截断）：
```
[ego_planner_node-5] [32miter(+1)=8,time(ms)=0.027,total_t(ms)=0.027,cost=0.212
[ego_planner_node-5] [0mtraj 1 success.
[ego_planner_node-5] plan_success=1
[ego_planner_node-5] total time:[42m0.00012[0m,optimize:0.00012,refine:1.8e-06,avg_time=0.00033
[ego_planner_node-5] refine_success=1
[ego_planner_node-5] [FSM]: from REPLAN_TRAJ to EXEC_TRAJ
[local_sense_cloud-6] [INFO] [1784900378.684232542] [drone_0_local_sense_cloud]: global cloud cached: 31782 points
[map_adapter-2] [INFO] [1784900379.441282229] [map_adapter]: adapted cloud #2940 width=33370 occ=136x88 topdown_cells=650
[ego_planner_node-5] [FSM]: state: EXEC_TRAJ
[local_sense_cloud-6] [INFO] [1784900380.291704090] [drone_0_local_sense_cloud]: local cloud #2950: 0 pts @ (-18.8,9.4,0.0)
[ego_planner_node-5] [FSM]: state: EXEC_TRAJ
[map_adapter-2] [INFO] [1784900381.443497391] [map_adapter]: adapted cloud #2960 width=33370 occ=136x88 topdown_cells=650
```
