...
private:
  ...
  // get depth image and camera pose
    ...
    void processCloud(const pcl::PointCloud<pcl::PointXYZ> & cloud);
...
rclcpp::TimerBase::SharedPtr vis_timer_;
  ...
  // Cache latched global cloud until odom is ready (and for re-ingest).
  pcl::PointCloud<pcl::PointXYZ> cached_cloud_;
  bool has_cached_cloud_{false};
  bool global_map_seeded_{false};
};
