...
map_adapter republishes to the alternate topic so any planner can consume any map.
"""
...
# --- Per-map planner overrides moved to their own contract module -----------
# (single source of truth; wrappers kept for import compatibility)
import drone_bringup.planner_map_params as _pmp  # noqa: E402
_pmp.bind_map_normalizer(normalize_map_id)
from drone_bringup.planner_map_params import (  # noqa: E402,F401
